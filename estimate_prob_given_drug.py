...
ASSESSMENT_CONFIGS = {
    ...
    "breast_cancer": AssessmentConfig(
        ...
        system_prompt=(
            ...
            "Male Breast Cancer Diagnosis Codes:\n"
            "  ICD-10CM:\n"
            "    C50.02* - Malignant neoplasm of nipple and areola, male "
            "(includes C50.02, C50.021, C50.022, C50.029)\n"
            "    C50.1*  - Malignant neoplasm of central portion of breast, male "
            "(includes C50.1, C50.12, C50.121, C50.122, C50.129)\n"
            "    C50.2*  - Malignant neoplasm of upper-inner quadrant of breast, male "
            "(includes C50.2, C50.22, C50.221, C50.222, C50.229)\n"
            "    C50.3*  - Malignant neoplasm of lower-inner quadrant of breast, male "
            "(includes C50.3, C50.32, C50.321, C50.322, C50.329)\n"
            "    C50.4*  - Malignant neoplasm of upper-outer quadrant of breast, male "
            "(includes C50.4, C50.42, C50.421, C50.422, C50.429)\n"
            "    C50.5*  - Malignant neoplasm of lower-outer quadrant of breast, male "
            "(includes C50.5, C50.52, C50.521, C50.522, C50.529)\n"
            "    C50.6*  - Malignant neoplasm of axillary tail of breast, male "
            "(includes C50.6, C50.62, C50.621, C50.622, C50.629)\n"
            "    C50.82* - Malignant neoplasm of overlapping sites of breast, male "
            "(includes C50.82, C50.821, C50.822, C50.829)\n"
            "    C50.92* - Malignant neoplasm of breast of unspecified site, male "
            "(includes C50.92, C50.921, C50.922, C50.929)\n"
            "    D05*    - Carcinoma in situ of breast "
            "(same as above)\n"
            "  ICD-9CM:\n"
            "    175*    - Malignant neoplasm of male breast "
            "(includes 175, 175.0, 175.9)\n\n"
            "Estimate the probability that a patient has breast cancer based solely on the provided "
